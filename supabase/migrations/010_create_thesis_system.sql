...
CREATE TABLE IF NOT EXISTS chapter_chunks (
  ...
  -- embedding_vector vector(1536), -- For OpenAI embeddings (uncomment when needed)
...
-- ============================================================================
-- UPDATE EXISTING TABLES: Add thesis support to pipeline/job tables
-- ============================================================================

-- Add chapter_version_id to pipeline_jobs
...
-- Add chapter_version_id to improvement_jobs
...
-- For now: allow all operations (will add auth later)
...
DO $$
BEGIN
  RAISE NOTICE '✅ Thesis system migration completed successfully!';
  RAISE NOTICE '   - Created tables: theses, chapters, chapter_versions, chapter_chunks';
  RAISE NOTICE '   - Added RLS policies';
  RAISE NOTICE '   - Created helper functions and views';
  RAISE NOTICE '   - Updated existing job tables with chapter_version_id';
END $$;
